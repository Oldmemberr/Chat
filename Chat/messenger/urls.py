...
from .views import UserListView, EditProfileView, UserProfileDetailView, ChatWithUserView, ChatListView, SendMessageView, EditMessageView, DeleteMessageView, GroupChatCreateView, GroupChatDetailView, SendGroupMessageView
